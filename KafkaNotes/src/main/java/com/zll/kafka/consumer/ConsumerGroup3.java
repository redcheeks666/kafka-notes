...
import com.zll.kafka.partition.GroupBroadcastPartition;
...
public class ConsumerGroup3 {
    ...
    public static Properties initProperties(){
        ...
        properties.put(ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG, GroupBroadcastPartition.class.getName());
        return properties;
    }
    ...
    public static void main(String[] args) {
        ...
        kafkaConsumer.subscribe(Arrays.asList(topic1,topic2), new ConsumerRebalanceListener() {
